...
<article class="page-container">
    ...
    <form action="{{ route('admin.update',$data) }}" method="post" class="form form-horizontal" id="form-admin-add">
        @csrf
        @method('PUT')
        <div class="row cl">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>初始密码：<input id="passwd" type="checkbox"></label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="sex" type="radio" id="sex-1" @if($data->sex=='先生') checked @endif value="先生">
                    <label for="sex-1">男</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="sex" @if($data->sex=='女士') checked @endif value="女士">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" value="{{ $data->email }}" class="input-text" placeholder="@" name="email" id="email">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">真实姓名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" value="{{ $data->truename }}" class="input-text" placeholder="" name="truename" id="truename">
            </div>
        </div>
        <div class="row cl">
